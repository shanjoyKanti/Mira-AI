      ...
      <Card>
        ...
        <div className="space-y-3">
          {reportEntries.map(([key, report], idx) => (
            <ReportCard key={key} reportKey={key} report={report} projectName={projectName} reportId={report.report_id ?? report.id} defaultExpanded={idx === 0} />
          ))}
        </div>
      </Card>
    );
...
// Updated by Moshiur Rahman on 2026-03-08
// Added: New feature implementation

// Updated by Moshiur Rahman on 2026-06-02
// Added: New feature implementation
