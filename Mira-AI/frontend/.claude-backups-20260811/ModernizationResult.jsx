 ...
 */
export const CompletionPanel = ({ result, projectName, onSecurityScan, onNewTransform, onDashboard }) => {
  const r            = result || {};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-600 via-primary-600 to-violet-700 p-6 text-white shadow-lg">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {totalFiles != null && (
          <div className="rounded-2xl border border-gray-200 bg-white p-4 hover:shadow-md transition-shadow">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-sky-600 flex items-center justify-center mb-3 shadow-sm">
        ...
        {upgraded != null && (
          <div className="rounded-2xl border border-gray-200 bg-white p-4 hover:shadow-md transition-shadow">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center mb-3 shadow-sm">
              <CheckCircle className="w-4 h-4 text-white" />
            </div>
            <p className="text-2xl font-extrabold text-gray-900">{upgraded}</p>
            <p className="text-xs text-gray-500 mt-0.5">Upgraded</p>
          </div>
        )}
        {withErrors != null && withErrors > 0 && (
          <div className="rounded-2xl border border-gray-200 bg-white p-4 hover:shadow-md transition-shadow">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center mb-3 shadow-sm">
              <FileCode className="w-4 h-4 text-white" />
            </div>
            <p className="text-2xl font-extrabold text-gray-900">{withErrors}</p>
            <p className="text-xs text-gray-500 mt-0.5">Had Errors</p>
          </div>
        )}
        {successRate != null && (
          <div className="rounded-2xl border border-gray-200 bg-white p-4 hover:shadow-md transition-shadow">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center mb-3 shadow-sm">
              <Code2 className="w-4 h-4 text-white" />
            </div>
            <p className="text-2xl font-extrabold text-gray-900">{successRate}%</p>
